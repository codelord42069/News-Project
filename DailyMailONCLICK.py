...
data = read_csv("dailymail_headlines.csv")
...
class DailyMailblueprintApp:
    def __init__(self, master=None):
        ...
        self.label10.configure(background='#ffffff', font='{Arial} 20 {}', text='Daily Mail Stories')
        self.label10.place(anchor='nw', relx='0.3', x='0', y='0')
